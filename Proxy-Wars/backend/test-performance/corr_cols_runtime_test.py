...
def test_get_results_on_modified_datasets(client):
    # List of datasets
    datasets = [
        os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'docs', 'test_data.csv')),
        ...
        os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'docs', 'census.csv')),
    ]
    ...
    for dataset in datasets:
        ...
        for percentage in percentages:
            ...
            for drop_column in columns:
                ...
                # target_var = 'Graduated' if 'Graduated' in columns and drop_column != 'Graduated' else columns[1]  # Ensure target variable exists
    ...
    output_csv = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'docs', 'corr_cols_runtime.csv'))
